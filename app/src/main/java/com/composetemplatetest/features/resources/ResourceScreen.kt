...
import com.composetemplatetest.core.ui.CircularProgressBar
        ...
        LazyColumn(
            ...
            resourceResult.apply {
                when {
                    ...
                    itemSnapshotList.isEmpty() -> item { Text(text = stringResource(com.composetemplatetest.R.string.no_data_found)) }
                }
            }
        }
